...
const en = {
  ...
  precisionStandard: 'Standard analysis',
  precisionHigh: 'High precision',
  precisionHint: 'High precision runs a beat model: slower to install, better on hard material',
  precisionUnavailable: 'High precision is available in the Python installation, not in the portable build',
...
const zh: Copy = {
  ...
  timeline: '时间轴',
  uploadSong: '上传歌曲',
  precisionStandard: '标准分析',
  precisionHigh: '高精度',
  precisionHint: '高精度会运行拍点模型：安装更重，在困难素材上更准',
  precisionUnavailable: '高精度需要 Python 安装版，便携版不含此功能',
