...
下载 **[Beathi Studio v0.12.0](https://github.com/chosuicide/beatscope/releases/download/v0.12.0/Beathi-Studio-v0.12.0-windows-x64.zip)**，解压后双击 **Beathi Studio.exe**。便携包已经带好分析器、浏览器和 FFmpeg。

### Python 3.10+

从 [v0.12.0 Release](https://github.com/chosuicide/beatscope/releases/tag/v0.12.0) 下载 wheel，然后运行：
